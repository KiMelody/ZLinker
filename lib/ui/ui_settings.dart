...
const _zh = {
  ...
  'tasks.scopeUnknown': '无法确定会话归属，未打开该任务',
  ...
  'chat.subscribe.timeout': '数据加载超时，请重试',
  'chat.reconnecting': '连接已断开，正在自动重连…',
  'chat.load.bridgeRecovering': '与桌面端的连接正在恢复…',
  'chat.load.slowHint': '正在建立连接，可能需要一点时间…',
  ...
  'chat.error.notConnected': '连接已断开，请返回重连后再试',
  'chat.error.timeout': '连接超时，请检查网络或桌面端后重试',
  ...
  'chat.files.undo': '撤销',
  'chat.subagent': '子代理 · \$0',
  'chat.agents.detailTitle': '子智能体',
  'chat.agents.stop': '停止',
  'chat.agents.stopConfirm': '确定停止这个子智能体吗？',
  'chat.subagentSheet.title': '子智能体',
  'chat.subagentSheet.count': '\$0 运行中 · 本次会话共 \$1 个',
  'chat.subagentSheet.sectionRunning': '运行中',
  'chat.subagentSheet.sectionEnded': '已结束',
  'chat.subagentSheet.detail': '详情',
  'chat.subagentSheet.loadMore': '加载更早',
  'chat.subagentSheet.allLoaded': '已全部加载 · 共 \$0 个',
  'chat.subagentSheet.status.stopped': '已停止',
  ...
  'chat.tool.agent.launching': '启动中',
  'chat.tool.agent.launched': '已启动',
  'chat.tool.agent.failed': '启动失败',
  'chat.tool.agent.stopped': '已停止',
  'chat.tool.agent.prompt': '提示词',
  'chat.subagent.status.running': '运行中',
  'chat.subagent.status.success': '已完成',
  'chat.subagent.status.failed': '失败',
  'chat.subagent.preparing': '准备执行…',
  ...
  'chat.replayable.queued': '排队中',
  'chat.replayable.sending': '发送中…',
  'chat.replayable.failed': '发送失败',
  'chat.replayable.undo': '撤销排队',
  ...
  'chat.interact.submitAnswers': '提交回答',
  'chat.interact.customAnswer': '自定义回答',
  'chat.interact.customHint': '输入自定义回答…',
  'chat.interact.answered': '已答 \$0/\$1',
  ...
  'chat.usage.contextValue': '\$0 / \$1（\$2）',
  'chat.usage.remaining.title': '剩余额度',
  'chat.usage.remaining.left': '剩余 · \$0',
  'chat.usage.limit.fiveHour': '5 小时',
  'chat.usage.limit.toolCalls': '工具调用',
  'chat.usage.limit.zcodeMcp': 'ZCode MCP',
  'chat.usage.resetCredits': '重置券 · 可用 \$0 张',
  'chat.usage.resetCreditsExpiry': '重置券 · 可用 \$0 张 · 最早 \$1 过期',
  'chat.contextUsage.breakdown.messages': '消息',
  'chat.contextUsage.breakdown.systemPrompt': '系统提示词',
  'chat.contextUsage.breakdown.metaUserContext': '元用户上下文',
  'chat.contextUsage.breakdown.skills': '技能',
  'chat.contextUsage.breakdown.toolPrompt': '工具提示',
  'chat.contextUsage.breakdown.systemTools': '系统工具 schema',
  'chat.contextUsage.breakdown.mcpTools': 'MCP 工具 schema',
  ...
  'chat.input.hint.queued': '继续输入以排队后续修改',
  'chat.code.lines': '\$0 行',
  ...
  'chat.quota.exhaustedTitle': '套餐额度已用尽',
  'chat.quota.exhaustedBody': '当前套餐额度已用尽或受限，可切换模型继续',
  'chat.quota.switchModel': '切换模型',
  'chat.quota.viewUsage': '查看用量',
  'chat.quota.useReset': '使用重置券',
  'usage.reset.title': '重置机会',
  'usage.reset.fiveHour': '5 小时池',
  'usage.reset.week': '每周池',
  'usage.reset.count': '\$0 张',
  'usage.reset.none': '暂无可用机会',
  'usage.reset.expiresIn': '\$0过期',
  'usage.reset.lastUsed': '上次使用重置：\$0',
  'usage.reset.action': '重置',
  'usage.reset.success': '已重置，额度已刷新',
  'usage.reset.failed': '重置失败: \$0',
  'usage.reset.unavailable': '重置机会需桌面端套餐数据可用',
  ...
  'usageRpc.appUsageFailed': '应用用量加载失败',
  'usageRpc.loadFailed': '加载失败: \$0',
  'usageRpc.remaining': '剩余额度',
  'usageRpc.remainingDetail': '剩余 \$0% · 重置机会 \$1过期',
  'usageRpc.remainingNoReset': '剩余 \$0%',
  'usageRpc.limits': '配额限制',
  'usageRpc.limitToken5h': '5 小时 token 窗口',
  'usageRpc.limitTokenWeek': '周 token 窗口',
  'usageRpc.limitToken': 'token 限额',
  'usageRpc.limitMonthlyTools': '月度内置工具用量',
  'usageRpc.serverMcp': '服务端 MCP 用量',
  ...
  'usageRpc.used': '用量 \$0',
  'usageRpc.left': '剩余 \$0',
  'usageRpc.notConfigured': '桌面端未配置套餐数据',
  'usageRpc.noPlan': '当前账号没有可用套餐',
  'usageRpc.loginRequired': '桌面端未登录',
  'usageRpc.primaryWeekly': '每周',
  'usageRpc.primaryFiveHour': '5 小时',
  'usageRpc.primaryToolCalls': '工具调用',
  'usageRpc.primaryTokens': 'Token 限额',
  'usageRpc.primaryOther': '其他限额',
  'usageRpc.primaryLeft': '剩 \$0%',
  'usageRpc.primaryCount': '\$0 次',
  'deskSet.title': '桌面设置',
...
const _en = {
  ...
  'tasks.scopeUnknown':
      "Couldn't determine the session's workspace; task not opened.",
  ...
  'chat.subscribe.timeout': 'Timed out loading — try again',
  'chat.reconnecting': 'Connection lost, reconnecting…',
  'chat.load.bridgeRecovering': 'Restoring the connection to the desktop…',
  'chat.load.slowHint': 'Establishing the connection, this can take a moment…',
  ...
  'chat.error.notConnected':
      'The connection is down. Go back and reconnect before retrying.',
  'chat.error.timeout':
      'Connection timed out. Check the network or the desktop app and retry.',
  ...
  'chat.agents.detailTitle': 'Subagent',
  'chat.agents.stop': 'Stop',
  'chat.agents.stopConfirm': 'Stop this subagent?',
  'chat.subagentSheet.title': 'Subagents',
  'chat.subagentSheet.count': '\$0 running · \$1 in this session',
  'chat.subagentSheet.sectionRunning': 'Running',
  'chat.subagentSheet.sectionEnded': 'Ended',
  'chat.subagentSheet.detail': 'Details',
  'chat.subagentSheet.loadMore': 'Load earlier',
  'chat.subagentSheet.allLoaded': 'All loaded · \$0 in total',
  'chat.subagentSheet.status.stopped': 'Stopped',
  ...
  'chat.tool.agent.launching': 'Launching',
  'chat.tool.agent.launched': 'Launched',
  'chat.tool.agent.failed': 'Launch failed',
  'chat.tool.agent.stopped': 'Stopped',
  'chat.tool.agent.prompt': 'Prompt',
  'chat.subagent.status.running': 'Running',
  'chat.subagent.status.success': 'Finished',
  'chat.subagent.status.failed': 'Failed',
  'chat.subagent.preparing': 'Preparing…',
  ...
  'chat.replayable.queued': 'Queued',
  'chat.replayable.sending': 'Sending…',
  'chat.replayable.failed': 'Failed to send',
  'chat.replayable.undo': 'Undo queued',
  ...
  'chat.interact.submitAnswers': 'Submit answers',
  'chat.interact.customAnswer': 'Custom answer',
  'chat.interact.customHint': 'Type a custom answer…',
  'chat.interact.answered': 'Answered \$0/\$1',
  ...
  'chat.usage.contextValue': '\$0 / \$1 (\$2)',
  'chat.usage.remaining.title': 'Remaining quota',
  'chat.usage.remaining.left': '\$0 remaining',
  'chat.usage.limit.fiveHour': '5 hours',
  'chat.usage.limit.toolCalls': 'Tool calls',
  'chat.usage.limit.zcodeMcp': 'ZCode MCP',
  'chat.usage.resetCredits': 'Reset credits · \$0 available',
  'chat.usage.resetCreditsExpiry': 'Reset credits · \$0 available · expire \$1',
  'chat.contextUsage.breakdown.messages': 'Messages',
  'chat.contextUsage.breakdown.systemPrompt': 'System prompt',
  'chat.contextUsage.breakdown.metaUserContext': 'Meta user context',
  'chat.contextUsage.breakdown.skills': 'Skills',
  'chat.contextUsage.breakdown.toolPrompt': 'Tool prompt',
  'chat.contextUsage.breakdown.systemTools': 'System tool schemas',
  'chat.contextUsage.breakdown.mcpTools': 'MCP tool schemas',
  ...
  'chat.input.hint.queued': 'Continue typing to queue changes',
  'chat.code.lines': '\$0 lines',
  ...
  'chat.quota.exhaustedTitle': 'Plan quota exhausted',
  'chat.quota.exhaustedBody':
      'Your plan quota is used up or limited — switch model to continue',
  'chat.quota.switchModel': 'Switch model',
  'chat.quota.viewUsage': 'View usage',
  'chat.quota.useReset': 'Use reset opportunity',
  'usage.reset.title': 'Reset opportunities',
  'usage.reset.fiveHour': '5-hour pool',
  'usage.reset.week': 'Weekly pool',
  'usage.reset.count': '\$0 available',
  'usage.reset.none': 'No opportunities available',
  'usage.reset.expiresIn': 'Expires in \$0',
  'usage.reset.lastUsed': 'Last reset used: \$0',
  'usage.reset.action': 'Reset',
  'usage.reset.success': 'Pool reset; quota refreshed',
  'usage.reset.failed': 'Reset failed: \$0',
  'usage.reset.unavailable': 'Requires desktop plan data',
  ...
  'usageRpc.appUsageFailed': 'App usage failed to load',
  'usageRpc.loadFailed': 'Load failed: \$0',
  'usageRpc.remaining': 'Remaining quota',
  'usageRpc.remainingDetail': '\$0% left · reset chances expire \$1',
  'usageRpc.remainingNoReset': '\$0% left',
  'usageRpc.limits': 'Quota limits',
  'usageRpc.limitToken5h': '5-hour token window',
  'usageRpc.limitTokenWeek': 'Weekly token window',
  'usageRpc.limitToken': 'Token limit',
  'usageRpc.limitMonthlyTools': 'Monthly built-in tool usage',
  'usageRpc.serverMcp': 'Server MCP usage',
  ...
  'usageRpc.notConfigured': 'Plan data is not configured on the desktop',
  'usageRpc.noPlan': 'No active plan on this account',
  'usageRpc.loginRequired': 'Not signed in on the desktop',
  'usageRpc.primaryWeekly': 'Weekly',
  'usageRpc.primaryFiveHour': '5-hour',
  'usageRpc.primaryToolCalls': 'Tool calls',
  'usageRpc.primaryTokens': 'Token limit',
  'usageRpc.primaryOther': 'Other limit',
  'usageRpc.primaryLeft': '\$0% left',
  'usageRpc.primaryCount': '\$0 left',
